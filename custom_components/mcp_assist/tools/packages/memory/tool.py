"""Built-in Memory package wrapper."""
...
class MemoryPackageTool(MCPAssistExternalTool):
    """Expose persisted memory tools through the package API."""
    ...
    def __init__(self, hass, manifest, tool_dir) -> None:
        ...
        self._delegate = MemoryTool(hass)
