...
from custom_components.mcp_assist.tools.packages.read_url.read_url import ReadUrlTool


class ReadUrlPackageTool(MCPAssistExternalTool):
    """Expose the read_url tool through the package API."""
    ...
    async def handle_call(
        ...
        """Delegate URL-reading tool calls to the package implementation."""
