"""Built-in LLM API Bridge package wrapper."""
...
class LLMApiBridgePackageTool(MCPAssistExternalTool):
    """Expose third-party LLM API bridge tools through the package API."""
    ...
    def __init__(self, hass, manifest, tool_dir) -> None:
        ...
        self._delegate = LLMApiBridgeTool(hass)
